...
public class CWCController {
    ...
    public String save(@Valid CWCEnrollmentForm cwcEnrollmentForm, ModelMap modelMap) {
        ...
        careService.enroll(new CwcVO(
                ...
                cwcEnrollmentForm.getLastVitaminA(),
                cwcEnrollmentForm.getMeaslesDate(),
                cwcEnrollmentForm.getLastMeasles(),
                ...
                cwcEnrollmentForm.getLastMalaria(),
                cwcEnrollmentForm.getLastMalariaDate(),
                cwcEnrollmentForm.getLastPnuemonia(),
                cwcEnrollmentForm.getLastPnuemoniaDate(),
                cwcEnrollmentForm.getLastDiarrhea(),
                cwcEnrollmentForm.getLastDiarrheaDate(),
