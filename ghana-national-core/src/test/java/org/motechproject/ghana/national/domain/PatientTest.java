...
public class PatientTest extends BaseUnitTest {
    ...
    public void shouldReturnAllApplicableCaresBasedOnHistoryInput() {
        ...
        CWCCareHistoryVO cwcCareHistoryVO = new CWCCareHistoryVO(true, cwcCareHistories, null, null, null, null, null, null, lastPentaDate, 1, null, null, 1, lastIPTiDate, 1, lastRotavirusDate,2,lastPneumococcalDate);
        HashMap<String, String> metaData = facilityMetaData(facilityId);
