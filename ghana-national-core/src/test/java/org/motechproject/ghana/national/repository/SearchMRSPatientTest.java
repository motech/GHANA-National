...
public class SearchMRSPatientTest {

    private SearchMRSPatient searchMRSPatient;

    @Before
    public void setUp() {
        searchMRSPatient =new SearchMRSPatient();
    }


    @Test
    public void testGetPatients() {
        String actualQuery = searchMRSPatient.createQuery("FIRSTN", "LASTN", "9876543210", new Date(2012, 3, 15), null);
    ...
    public void testGetPatientsUsingName() {
        String actualQuery = searchMRSPatient.createQuery("FIRSTNAME", "LASTNAME", null, null, null);
    ...
    public void testGetPatientsUsingDateOfBirthAlone() {
        String actualQuery = searchMRSPatient.createQuery(null, null, null, new Date(2012, 3, 15), null);
