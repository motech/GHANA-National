    ...
    protected void load() {
        ...
        try {
            ...
            for (DayOfWeek weekDay : weekDays()) {
                ...
                mappings.add(dayTime(weekDay, "0209849369", Language.GD));
                mappings.add(dayTime(weekDay, "0209849366", Language.EWE));

                mappings.add(nurseLine(weekDay, "0208516182"));
                mappings.add(evening(weekDay, "0544347554", Language.EN));
                mappings.add(evening(weekDay, "0544347552", Language.FAN));
                mappings.add(evening(weekDay, "0209849369", Language.GD));
                mappings.add(evening(weekDay, "0209849366", Language.EWE));

                mappings.add(earlyMorning(weekDay, "0544347552", Language.EN));
                mappings.add(earlyMorning(weekDay, "0544347552", Language.FAN));
                mappings.add(earlyMorning(weekDay, "0209849369", Language.GD));
                mappings.add(earlyMorning(weekDay, "0209849366", Language.EWE ));
            }
            ...
            mappings.add(weekend(DayOfWeek.Saturday, "0209849369", Language.GD ));
            mappings.add(weekend(DayOfWeek.Saturday, "0209849366", Language.EWE));
