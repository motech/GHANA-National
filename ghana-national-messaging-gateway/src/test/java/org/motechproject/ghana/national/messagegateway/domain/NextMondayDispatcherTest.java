...
public class NextMondayDispatcherTest {
    ...
    public void shouldReturnDateOfUpComingMondayGiveADate(){
        ...
        DateTime returnedNextMondayDate = new NextMondayDispatcher().deliveryDate(new TestPayload(generationTime, null, "id"));
        ...
        returnedNextMondayDate = new NextMondayDispatcher().deliveryDate(new TestPayload(generationTime, null, "id"));
